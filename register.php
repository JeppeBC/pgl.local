...
function create_user($user, $pass_) {
  $RESPONSE_VALIDATE_USER_TOPIC = "response_validate_user_topic";
  $REQUEST_STORE_USER_IN_DB_TOPIC = "request_store_user_in_db_topic"; 
  ...
  function listen_response() {
    global $RESPONSE_VALIDATE_USER_TOPIC, $hostname;
    global $REQUEST_STORE_USER_IN_DB_TOPIC, $hostname;

    $mqtt->subscribe(
      (new TopicFilter)
        ->setTopic($RESPONSE_VALIDATE_USER_TOPIC)
